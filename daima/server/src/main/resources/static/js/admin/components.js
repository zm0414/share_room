    ...
    template: 
	  ...
	  '<header class="main-header">'+
	    '<a href="javascript:;" class="logo">'+
	      ...
	      '<span class="logo-mini"><b>选座</b></span>'+
	      '<!-- logo for regular state and mobile devices -->'+
	      '<span class="logo-lg"><b>自习室预约小程序</b></span>'+
	    '</a>'+
	...
	template:
	  '<footer class="main-footer">'+
	    '<div class="pull-right hidden-xs">'+
	      'V '+
	    '</div>'+
	    'Copyright &copy; 2022 <a href="http://www.hamu.site" target="_blank">evanluns</a>'+
	  '</footer>'
});
